...
$(function() {
	...
	//회원정보열기
	$('.mb-info-open').click(function(){
		var mb_id=$(this).attr('data-id');
		
		window.open(g5_admin_url+'/coin_admin/open_user_info.php?mb_id='+mb_id,'mb-info-'+mb_id,'width=1300,height=1000,resizable=yes,scrollbars=yes');
