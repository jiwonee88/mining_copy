...
//VIp
$_temp4 = sql_fetch(" select count(*) as cnt from {$g5['member_table']} where mb_10 not in ('1','2') and mb_14='vip'  ");
?>
...
$(function(){
	...
	//탈퇴회원
	<? if($_temp4[cnt]){?>
	$(".gnb_oparea li[data-menu='200190']").html($(".gnb_oparea li[data-menu='200190']").html()+' <span class="lsbtn lsbtn-xxx obje-red"><?=$_temp4[cnt]?></span>')
	<? }?>
