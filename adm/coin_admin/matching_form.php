...
<td><input name="in_rsv_amt" type="text"  class="required frm_input number-comma" id="in_rsv_amt" required="required" value="<?php echo number_format2($data['in_set_amt'])?>" size="20" <?=$disabled?>/></td>
</tr>
