...
$sql_search = " where mb_trade_penalty > 0 ";
...
$sql = " select count(*) as cnt {$sql_common} where mb_trade_penalty ='1' ";
$row = sql_fetch($sql,1);
$total_1 = $row['cnt'];
$sql = " select count(*) as cnt {$sql_common} where mb_trade_penalty ='2' ";
$row = sql_fetch($sql);
$total_2 = $row['cnt'];
$sql = " select count(*) as cnt {$sql_common} where mb_trade_penalty ='3' ";
$row = sql_fetch($sql);
$total_3 = $row['cnt'];
$sql = " select count(*) as cnt {$sql_common} where mb_trade_penalty >='4' ";
$row = sql_fetch($sql);
$total_4 = $row['cnt'];
