...
<select name='manual_stx' class="form-control input-sm  w-auto  mb-1" id="manual_stx" >
<option value=''>-소유형태-</option>
<option value='1' <?=$manual_stx=='1'?'selected':''?> >직접지급</option>
<option value='0' <?=$manual_stx=='0'?'selected':''?> >구매소유</option>
...
<input type="submit" name="act_button" value="선택삭제" onclick="document.pressed=this.value" class="btn_01 btn">
    <a href="./item_give_form.php" id="rt_add" class="btn_04 btn"	>직접지급</a>
</div>
