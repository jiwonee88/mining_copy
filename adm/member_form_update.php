...
$temp=sql_fetch("select * from $g5[member_table] where mb_12='$mb_12' and mb_id!='$mb_id' ");
if ( $temp[mb_id]) {          
	alert("입력하신 UID는 이미 사용중입니다");
}

if ($_REQUEST['certify_stx']!='') {		
	$qstr.="&certify_stx=$certify_stx";
}	
...
$sql_common = "  mb_name = '{$_POST['mb_name']}',
				 ...
				 mb_datetime = '{$_POST['mb_datetime']}', 
					mb_trade_amtlmt= '{$_POST['mb_trade_amtlmt']}'  
				 ";
