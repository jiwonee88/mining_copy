...
$menu['menu700'] = array(
    ...
    array('700600', '거래목록', ''.G5_CN_ADMIN_URL.'/item_trade_list.php', 'item_trade'),
    
    array('700610', '매칭현황', ''.G5_CN_ADMIN_URL.'/item_matching_user_stat.php', 'matching'),
    
    array('700710', '매칭대기', ''.G5_CN_ADMIN_URL.'/item_matching.ready.php', 'matching'),
    ...
    array('700860', $g5[cn_item_name].'삭제내역', ''.G5_CN_ADMIN_URL.'/item_cart_trash.php', 'cart_trash'),
    ...
    array('700910', '회원설정일괄처리', ''.G5_ADMIN_URL.'/member_excel_config_form.php', 'coin_draw'),
