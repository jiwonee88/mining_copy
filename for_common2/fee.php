        ...
        <div class="wrap">
            ...
            <div class="area area02">
                <ul class="buy sell">
                    ...
                    <li class="squareWB" onclick="location.href='/for_common/idDetail.php'"><span class="f_yellow">$<?=number_format2($member[mb_trade_amtlmt]-$isum[tot][price])?></span><span
			...
			<form name='buyform' id='buyform' onsubmit='buyform_submit(this);' >
                ...
                <ul>
                    ...
                    <li style="margin-top:20px;">
                        <p  class='w-100 text-left'>최종 지급 수량 : <span id='amt_str'>0</span> GOLD</p>
                    </li>
                    <li >
