        ...
        <div class="wrap" >
            <div class="area area01">
                ...
                <ul class="common">
					...
					<li class="squareWB stone w50"><a href="/for_common/fee.php"><span class="stoneBg confirm gold-enable"   ><?=number_format2($rpoint['i']['_enable'])?></span></a></li>
                </ul>
            </div>
            <div class="area area02">
                <ul class="buy">
                    ...
                    <li class="squareWB">
                        <span class="f_yellow  mb_trade_amtenable">$<?=number_format2($isum[tot][price]>$member[mb_trade_amtlmt]?0:$member[mb_trade_amtlmt]-$isum[tot][price])?></span><span class="condition">가용금액</span>
            ...
            <div class="area area02 area03">
                <ul class="buy" id='subAccount' >
                    ...
                    <li class="squareWB">					
                        ...
                        <div class="stoneBox">
                            <span class="stone"><span  class='gold-enable-<?=$ac[ac_id]!=$ac[mb_id]?$ac[ac_no]:$ac[ac_id]?>' ><?=number_format2($ac['ac_point_i'])?></span></span>
