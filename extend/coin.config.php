...
$g5['cn_item_cart_trash'] =$g5['cn_prefix'].'item_cart_trash'; 			// 상품 보유 테이블 - 휴지통

$g5['cn_item_trade'] =$g5['cn_prefix'].'item_trade'; 		// 상품 매칭 테이블
$g5['cn_item_trade_test'] =$g5['cn_prefix'].'item_trade_test'; 		// 새뮬레이션 용
...
$g5['cn_item_purchase']=$g5['cn_prefix'].'item_purchase'; 		// 상품구매 테이블
...
"pin"=>"Deposit",//구매입금",
"in"=>"Deposit",//입금",
"Inherit"=>"Subaccount point inheritance",	//삭제 되는 서브 계정 포인트 상속
"joinb"=>"JoinBonus",//가입축하금",
"buy"=>"Purchase",//입금",
...
"fee2"=>"Community Market Income",	//직급보너스",
...
//트윌로 문자 서비스
$g5['cn_id']='ACcb83762a7ba19638a044ae0a361f0b0a';
$g5['cn_token']='';
$g5['cn_callback']="+";
...
if($_SERVER[REMOTE_ADDR]=='59.28.52.143' || $_REQUEST[_is_debug]=='y') $_is_debug=true;
else  $_is_debug=false;
