  ...
  <div id="wrap">
    ...
    <div id="log" style="background: #000 url(<?=G5_THEME_URL?>/images/loginBg.jpg) no-repeat;">
     ...
     <input name="mb_id" type="text"  id="reg_mb_id" placeholder="Member ID" required >
      ...
      <h3>인증번호</h3>
      <input name="mb_hp_certi" type="text"  id="reg_mb_hp_certi" placeholder="인증번호입력" required class='' >
      <button class="phone" id='hp_comfirm_btn' >
        인증 확인
      </button>
      <h3>추천인 코드</h3>
      <input name="mb_recommend" type="text"  id="reg_mb_recommend" placeholder="Referral Code" autocomplete='off' >
      <div class="btns" type='submit'>
        <button type='submit' id='sign_up_btn' >확인</button>
        <button type='button' class="exit" onclick="document.location.href='/bbs/login.php';">취소</button>
      </div>
    </div>
  </div>
