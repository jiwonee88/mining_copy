...
function g5_path()
{
    ...
    $http = 'http' . ((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS']=='on') || $_SERVER['HTTP_X_FORWARDED_PROTO']=='https' ? 's' : '') . '://'; 
...
// 회원, 비회원 구분
$is_member = $is_guest =$is_partner=$is_manager=false;
$is_admin = '';
if ($member['mb_id']) {
    $is_member = true;
	...
	if($member['mb_level']=='5') $is_partner=true;
	if($member['mb_level']=='10') $is_manager=true;
